/**
 * Simple Node.js test for Brotli2 v4.1
 */

import Brotli2V4_1 from './brotli2-prototype-v4-1.js';

console.log('\n=== Brotli2 v4.1 Node.js Test ===\n');

try {
    const brotli2 = new Brotli2V4_1();
    ...
    console.log('\nTest 2: HTML compression');
    const html = '<!DOCTYPE html><html><head><title>Test</title></head><body><div class="container"><h1>Header</h1><p>Paragraph</p></div></body></html>';
