...
async function Java_org_lwjgl_opengl_LinuxDisplay_nGetAvailableDisplayModes(lib)
{
	...
	var d1 = await new DisplayMode(1280, 768);
	var d2 = await new DisplayMode(1920, 1080);
	return [d1, d2];
}
...
function Java_org_lwjgl_opengl_LinuxDisplay_nUpdate()
{
	if (typeof window !== "undefined" && !window.LWJGL_LinuxUpdateLogged) {
		window.LWJGL_LinuxUpdateLogged = true;
		console.log("[LWJGL] LinuxDisplay.nUpdate called");
	}
	return Java_org_lwjgl_opengl_LinuxContextImplementation_nSwapBuffers();
}

function Java_org_lwjgl_opengl_LinuxDisplay_nSwapBuffers()
{
	if (typeof window !== "undefined" && !window.LWJGL_LinuxSwapLogged) {
		window.LWJGL_LinuxSwapLogged = true;
		console.log("[LWJGL] LinuxDisplay.nSwapBuffers called");
	}
	return Java_org_lwjgl_opengl_LinuxContextImplementation_nSwapBuffers();
}
...
{
	if (typeof window !== "undefined" && !window.LWJGL_ContextCreated) {
		window.LWJGL_ContextCreated = true;
		console.log("[LWJGL] Context created", { hasGL: !!glCtx });
	}
	return glCtx ? 1 : 0;
}
...
{
	if (typeof window !== "undefined" && !window.LWJGL_ContextCurrent) {
		window.LWJGL_ContextCurrent = true;
		console.log("[LWJGL] Context made current");
	}
	return glCtx ? 1 : 0;
}
...
function Java_org_lwjgl_opengl_LinuxContextImplementation_nSwapBuffers()
{
	...
	if (typeof window !== "undefined" && !window.LWJGL_SwapLogged) {
		window.LWJGL_SwapLogged = true;
		console.log("[LWJGL] SwapBuffers called", { hasGL: !!glCtx });
	}
...
function Java_org_lwjgl_opengl_Display_nUpdate()
{
	return Java_org_lwjgl_opengl_LinuxContextImplementation_nSwapBuffers();
}

function Java_org_lwjgl_opengl_Display_nSwapBuffers()
{
	return Java_org_lwjgl_opengl_LinuxContextImplementation_nSwapBuffers();
}
...
export default {
	...
	Java_org_lwjgl_opengl_LinuxDisplay_nUpdate,
	Java_org_lwjgl_opengl_LinuxDisplay_nSwapBuffers,
	Java_org_lwjgl_opengl_Display_nUpdate,
	Java_org_lwjgl_opengl_Display_nSwapBuffers,
