...
def main() -> int:
    ...
    required = {
        ...
        "tests/e2e/pioneer-workload-render-profile.spec.js",
        "tests/e2e/pioneer-mobile-commands.spec.js",
        ...
        "exoplanet-engine/renderer.js",
        "exoplanet-engine/viewer.js",
        "data/exoplanet-engine/current.json",
        "schemas/exoplanet-engine-1.0.0.schema.json",
        "scripts/build-engine-release.mjs",
        "scripts/validate-engine-release.mjs",
        "scripts/check-engine-production.mjs",
        "scripts/fetch-engine-sources.py",
        "tests/exoplanet-engine/evidence.test.mjs",
        "tests/e2e/exoplanet-engine.spec.js",
        ".github/workflows/exoplanet-source-review.yml",
