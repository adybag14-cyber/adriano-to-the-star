...
function Invoke-ProductionHealthCheck {
    ...
    $Checks = @(
        ...
        @{ Path = "/site-header.js?v=$ReleaseMarker"; Contains = "data-shared-site-header" },
        @{ Path = "/database-previews.js?v=$ReleaseMarker"; Contains = "spectrum-linked" },
        @{ Path = "/experimental/procedural-planets/forge-v5.js?v=$ReleaseMarker"; Contains = "class PlanetaryForgeV5" },
        @{ Path = "/experimental/fluid-nebula/nebula-v5.js?v=$ReleaseMarker"; Contains = "RGBA32F" },
        @{ Path = "/data/planet-texture-provenance.json?deploy=$CacheKey"; Contains = "mercury-equirectangular-8k.jpg" },
